...
_DEFAULTS: dict = {
    ...
    "curation_perturbations": {
        "forced_merge_pairs": 0,
        "noise_clusters": 0,
...
class SettingConfig:
    ...
    # --- controlled initial curation errors (simulation only) ---
    forced_merge_pairs: int = 0
    noise_clusters: int = 0
    noise_spikes_per_cluster: int = 600
    ...
    def load(
        ...
        o = cfg.get("overlap", {})
        a = cfg.get("artifact", {})
        cp = cfg.get("curation_perturbations", {})
        ...
        return cls(
            ...
            forced_merge_pairs=int(cp.get("forced_merge_pairs", 0)),
            noise_clusters=int(cp.get("noise_clusters", 0)),
            noise_spikes_per_cluster=int(cp.get("noise_spikes_per_cluster", 600)),
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "curation_perturbations": {
                "forced_merge_pairs": self.forced_merge_pairs,
                "noise_clusters": self.noise_clusters,
                "noise_spikes_per_cluster": self.noise_spikes_per_cluster,
            },
            "teacher_criteria": {
