...
class TrajectoryStep:
    ...
    rag_enabled: bool = False                              # Whether RAG was active
    rag_hits: int = 0                                      # Number of retrieved examples
    retrieved_examples: List[Dict[str, Any]] = field(default_factory=list)  # Retrieved few-shot examples
